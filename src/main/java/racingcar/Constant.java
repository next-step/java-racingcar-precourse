...
public class Constant {
    ...
    public static final String RACE_ROUND_INPUT_MESSAGE = "시도할 회수는 몇회인가요?";
    ...
    public static final String ERROR_RACE_ROUND = ERROR_PREFIX + "올바른 입력의 회수가 아닙니다";
    public static final String ERROR_RACE_ROUND_NON_POSITIVE_INTEGER = ERROR_PREFIX + "회수는 1이상의 수여야합니다.";
    ...
    public static final int MIN_RACE_ROUND = 1;
