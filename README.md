...
* 원시값 포장`(21.10.08 추가)`
    * 0 ~ 9 까지 랜덤값 입력을 위한 Positive 클래스 생성
    * 1 ~ 5 까지 자동차 이름 입력을 위한 CarName 클래스 생성
    <br><br>
* 자동차 생성
    * n대의 자동차 생성 가능
    * 전진 또는 멈춤 기능 필요
...
* 들여쓰기`1`제한 위반 (반복문)
    ...
    ```
## 🎁원시값을 포장하라
> * 원시값 포장 없이 예외에 대해 주석 혹은 문서를 잘 작성해둔다고 할지라도 함께 개발하는 개발자가 보지 않으면 이슈가 발생할 수 있다.
> * Positive 양수라는 이름을 사용하여 변수를 사용하면 주석이나 문서를 보지 않고도 함께 개발하는 개발자도 의도를 파악할 수 있다.
