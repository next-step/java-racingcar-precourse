...
* Domain:
    * Accelerator
        * [X]  ~~값을 가진다.~~ 경계 값을 가진다.
            > 랜덤값을 저장할 필요 없이 바로 판단하면 된다.
        * [x] 랜덤값을 생성할 수 있다.
        * [x] 전진 여부를 전달 할 수 있다. (4이상)
...
## 느낀점
* indent를 줄이는 노력을 하다 보니 보니 메소드의 책임과 역할이 명확해 지는듯 하다.

## 향후 생각 해 볼 사항
* [ ] 더 적극적인 TestCase 우선 작성
* [ ] 더 적극적인 README 우선 작성

* [ ] 객체지향적 사고
    * [ ] 책임과 역할 분리
    * [ ] 절차지향적 로직
    >> 절차적 로직에 선후관계가 필요한 경우
    >> 메소드간 종속성 발생
    * [ ] 적절한 Domain 설계 
    * [ ] setter 사용 자제
