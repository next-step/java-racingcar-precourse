...
public class CarName {
    ...
    private void validateCarName(String name) {
        if (isNullOrEmpty(name) || UtilsConstant.MAX_CAR_NAME < name.length()) {
            throw new IncorrectInputException(String.format("%d 글자 이하의 이름를 입력할 수 없습니다.", UtilsConstant.MAX_CAR_NAME));
        }
    }
