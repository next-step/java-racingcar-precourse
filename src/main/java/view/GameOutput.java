...
public class GameOutput {
    ...
    private static final String ENTER_ATTEMPT_COUNT = "시도할 횟수는 몇 회인가요?";
    private static final String ENTER_ATTEMPT_COUNT_POSITIVE = "시도 횟수는 1 이상의 숫자로 입력해 주세요.";
    private static final String GAME_RESULT_COMMENT = "실행 결과";
    private static final String GAME_WINNER_SUFFIX = "가 최종 우승했습니다.";
    ...
    public static void printReEnter(String message) {
        System.out.println(message + " " + RE_ENTER);
    }

    public static void printEnterAttemptCount() {
        System.out.println(ENTER_ATTEMPT_COUNT);
    }

    public static void printEnterAttemptCountPositive() {
        System.out.println(ENTER_ATTEMPT_COUNT_POSITIVE);
    }
    ...
    public static void printWinners(List<String> winners) {
        ...
        System.out.println(GAME_WINNER_SUFFIX);
    }
